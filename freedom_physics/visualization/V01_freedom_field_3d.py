...
visualization/V01_freedom_field_3d.py — freedom_field_3d visualization.
...
TITLE = "freedom_field_3d [SIMULATED — F=P/D HYPOTHESIS UNDER TEST]"


def render(output_dir: str = None) -> dict:
    """Render freedom_field_3d visualization. Returns dict of export paths."""
    outdir = output_dir or VIZ_DIR
    base   = os.path.join(outdir, "freedom_field_3d")
    return {
        "html":  base + ".html",
        "stl":   base + ".stl",
        "gltf":  base + ".gltf",
