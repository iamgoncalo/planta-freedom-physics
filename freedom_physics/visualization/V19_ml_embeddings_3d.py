...
visualization/V19_ml_embeddings_3d.py — ml_embeddings_3d visualization.
...
TITLE = "ml_embeddings_3d [SIMULATED — F=P/D HYPOTHESIS UNDER TEST]"


def render(output_dir: str = None) -> dict:
    """Render ml_embeddings_3d visualization. Returns dict of export paths."""
    outdir = output_dir or VIZ_DIR
    base   = os.path.join(outdir, "ml_embeddings_3d")
    return {
        "html":  base + ".html",
        "stl":   base + ".stl",
        "gltf":  base + ".gltf",
