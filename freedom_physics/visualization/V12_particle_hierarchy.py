...
visualization/V12_particle_hierarchy.py — particle_hierarchy visualization.
...
TITLE = "particle_hierarchy [SIMULATED — F=P/D HYPOTHESIS UNDER TEST]"


def render(output_dir: str = None) -> dict:
    """Render particle_hierarchy visualization. Returns dict of export paths."""
    outdir = output_dir or VIZ_DIR
    base   = os.path.join(outdir, "particle_hierarchy")
    return {
        "html":  base + ".html",
        "stl":   base + ".stl",
        "gltf":  base + ".gltf",
