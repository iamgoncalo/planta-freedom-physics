...
visualization/V18_innovation_map.py — innovation_map visualization.
...
TITLE = "innovation_map [SIMULATED — F=P/D HYPOTHESIS UNDER TEST]"


def render(output_dir: str = None) -> dict:
    """Render innovation_map visualization. Returns dict of export paths."""
    outdir = output_dir or VIZ_DIR
    base   = os.path.join(outdir, "innovation_map")
    return {
        "html":  base + ".html",
        "stl":   base + ".stl",
        "gltf":  base + ".gltf",
