...
visualization/V06_intelligence_paradox.py — intelligence_paradox visualization.
...
TITLE = "intelligence_paradox [SIMULATED — F=P/D HYPOTHESIS UNDER TEST]"


def render(output_dir: str = None) -> dict:
    """Render intelligence_paradox visualization. Returns dict of export paths."""
    outdir = output_dir or VIZ_DIR
    base   = os.path.join(outdir, "intelligence_paradox")
    return {
        "html":  base + ".html",
        "stl":   base + ".stl",
        "gltf":  base + ".gltf",
